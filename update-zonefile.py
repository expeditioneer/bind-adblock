...
lists = [
    ...
    # # StevenBlack's list
    # {'url': 'https://raw.githubusercontent.com/StevenBlack/hosts/master/hosts', 'regex': regex_domain,
    #  'filter': regex_no_comment},
    # # Cameleon
    ...
    #
    # # Disconnect.me
    # {'url': 'https://s3.amazonaws.com/lists.disconnect.me/simple_malvertising.txt', 'regex': regex_skip_space,
    #  'filter': regex_no_comment},
    # {'url': 'https://s3.amazonaws.com/lists.disconnect.me/simple_malware.txt', 'regex': regex_skip_space,
    #  'filter': regex_no_comment},
